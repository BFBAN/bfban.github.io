...
<b>{{$t("home.bulletin.engCon")}}:</b> <a href="https://live.bilibili.com/591314">___4Tr1</a><br> -->
		  ...
		  <b>{{$t("home.bulletin.localManager")}}:</b> <a href="https://docs.qq.com/doc/DZFVocWxyTE5tR1lT" target="_blank">Windows</a> <a href="https://manager.gametools.network" target="_blank">Web</a> <a href="https://suzubucket.cc/bot-python/" target="_blank">QQbot</a><br>
	   </div>
